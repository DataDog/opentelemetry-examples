...
var configs = []config{
	...
	{"k8s-objects-datadog", "otelcol-k8s-objects", k8sEnvs, map[string]any{"Container": true, "K8s": true, "Deployment": true, "DatadogExporter": true, "KSM": true, "K8sObjects": true}},
	{"helm-values/daemonset", "helm-daemonset", k8sEnvs, map[string]any{"KubeletStats": true}},
	{"helm-values/k8s-objects-datadog", "helm-k8s-objects", k8sEnvs, map[string]any{"Container": true, "K8s": true, "Deployment": true, "DatadogExporter": true, "KSM": true, "K8sObjects": true}},
