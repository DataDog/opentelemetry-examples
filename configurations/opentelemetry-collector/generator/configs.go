...
var configs = []config{
	...
	{"testing/otel-demo-datadog", "otel-demo", []string{"eks"}, map[string]any{"DatadogExporter": true, "Testing": true}},
	{"testing/otel-demo", "otel-demo", k8sEnvs, map[string]any{"Testing": true}},
}
