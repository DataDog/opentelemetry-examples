...
```bash
helm install rolldice ./helm-chart \
  --set otelCollector.datadog.apiKey="your-datadog-api-key" \
...
| `otelCollector.datadog.apiKey` | Datadog API key for metrics export | `""` |
...
otelCollector:
  datadog:
    apiKey: "your-production-datadog-key"
```
...
```bash
helm upgrade rolldice ./helm-chart --set otelCollector.datadog.apiKey=""
```
