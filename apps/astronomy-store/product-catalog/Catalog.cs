public static class Catalog
{
    ...
    [
        new(
            ...
            "The National Park Foundation's (NPF) Explorascope 60AZ is a manual alt-azimuth, refractor telescope perfect for celestial viewing on the go. The NPF Explorascope 60 can view the planets, moon, star clusters and brighter deep sky objects like the Orion Nebula and Andromeda Galaxy.",
            "NationalParkFoundationExplorascope.jpg",
            new Price("USD", 101, 960000000),
            ["telescopes"]),
        new(
            "66VCHSJNUP",
        ...
        new(
            ...
            "RoofBinoculars.jpg",
            new Price("USD", 209, 950000000),
            ["binoculars"]),
        new(
            "0PUK6V6EV0",
            "Solar System Color Imager",
            "You have your new telescope and have observed Saturn and Jupiter. Now you're ready to take the next step and start imaging them. But where do you begin? The NexImage 10 Solar System Imager is the perfect solution.",
        ...
        new(
            "LS4PSXUNUM",
            "Red Flashlight",
            "This 3-in-1 device features a 3-mode red flashlight, a hand warmer, and a portable power bank for recharging your personal electronics on the go. Whether you use it to light the way at an astronomy star party, a night walk, or wildlife research, ThermoTorch 3 Astro Red's rugged, IPX4-rated design will withstand your everyday activities.",
            "RedFlashlight.jpg",
            new Price("USD", 57, 80000000),
